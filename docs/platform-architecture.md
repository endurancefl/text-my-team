...
| `updateContract` | Estimating | Updates existing contract row by contractId — all fields including paymentTerms, contractValue, ccFeePercent, ccGrossUp, contactName, contactEmail, billingAddress, billingContactName, billingContactEmail, pdfUrl, pdfFileId |
