...
- **Service Catalog**: Pre-configured service templates with default visits, billing tiers, proposal names, descriptions, map colors, line item assignments
...
| `getServiceCatalog` | Estimating | Returns service catalog |
