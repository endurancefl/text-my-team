...
├── estimate.html                  # Bidding & estimating tool (~14,719 lines HTML/JS)
...
├── backend/
│   └── combined-apps-script.js    # Google Apps Script backend (~4,586 lines)
...
**estimate.html + estimate.css — Bidding & Estimating Tool (~14,719 lines HTML/JS + ~5,444 lines CSS)**
