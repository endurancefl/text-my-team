...
**Bad:** "Alert! The irrigation system pressure is critically low. Immediate action required!"
**Good:** "Irrigation pressure on the Parkway account dropped below threshold. Likely a line break in Zone 3. I've flagged the crew — though I suspect the backhoe operator from Tuesday may already know what happened."
